...
import SwiperControllsSell from "./SwiperControllsSell";
import { Swiper, SwiperSlide } from "swiper/react";
import { Autoplay } from "swiper";
import "swiper/css";
import "swiper/css/pagination";

import "./stylessell.css";
...
const SliderSells = () => {
  ...
  useEffect(()=>{
      ( async () =>{ 
          ...
          try {
              ...
              const q = query(collection(db, "products"), where("bestsell", "==", true));
  ...
  return (
    ...
    <p className="titleSellp">LO MAS VENDIDO</p>
    </div>
      <Swiper
        loop={true}
        slidesPerView={1}
